...
class ConfDef:
    ...
    SNAPSHOT_INPATH: str = os.path.join("out",
                                        "model_snapshots",
                                        "OnsetsAndVelocities_2024_03_26_15_06_49.015__step=71000_f1=0.9621__0.9353.torch")
    #
...
if __name__ == "__main__":
    ...
    test_results_df.to_csv(os.path.join(results_folder, 'full_pud_test_results_5.csv'), index=False)
    test_results_df_vel.to_csv(os.path.join(results_folder, 'full_pud_test_results_5_vel.csv'), index=False)
