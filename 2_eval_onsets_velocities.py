...
class ConfDef:
    ...
    SNAPSHOT_INPATH: str = os.path.join("out",
                                        "model_snapshots",
                                        "OnsetsAndVelocities_2024_02_16_01_28_53.825__step=16000_f1=0.9873__0.9873.torch")
    #
...
if __name__ == "__main__":
    ...
    test_results_df.to_csv(os.path.join(results_folder, 'mono5_test_results.csv'), index=False)
    test_results_df_vel.to_csv(os.path.join(results_folder, 'mono5_test_results_vel.csv'), index=False)
