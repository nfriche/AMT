...
class ConfDef:
    ...
    SNAPSHOT_INPATH: str = os.path.join("out",
                                        "model_snapshots",
                                        "OnsetsAndVelocities_2024_03_01_08_27_19.535__step=143000_f1=0.9649__0.9477.torch")
    #
...
if __name__ == "__main__":
    ...
    test_results_df.to_csv(os.path.join(results_folder, '5_10_test_results.csv'), index=False)
    test_results_df_vel.to_csv(os.path.join(results_folder, '5_10_test_results_vel.csv'), index=False)
