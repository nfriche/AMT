...
class ConfDef:
    ...
    SNAPSHOT_INPATH: str = os.path.join("out",
                                        "model_snapshots",
                                        "OnsetsAndVelocities_2024_03_16_03_48_26.846.torch")
    #
...
if __name__ == "__main__":
    ...
    test_results_df.to_csv(os.path.join(results_folder, 'full_pud_test_results.csv'), index=False)
    test_results_df_vel.to_csv(os.path.join(results_folder, 'full_pud_test_results_vel.csv'), index=False)
